...
/**
 * D-DAY 알림 토글 결과 응답 DTO
 * - enabled: 최종 ON/OFF 상태
 * - nextDate/scheduledAt: ON인 경우 다음 예약 정보(없으면 null)
 * - reservationCreated: 이번 호출에서 신규 예약을 만들었는지
 * - canceledCount: OFF 시 취소(상태 변경)된 예약 개수
 */
@Getter
@Builder
@NoArgsConstructor
